...
check.bin: tmp/check.o tmp/check_comparison.o tmp/check_parse_stringify.o tmp/check_reference.o
	$(LINKER_EXE) $(LINKER_EXE_FLAGS) $(opts_feb8a140c0d0f69d31572276363b144b) -o check.bin tmp/check.o tmp/check_comparison.o tmp/check_parse_stringify.o tmp/check_reference.o

all: check.bin
.PHONY: all
clean:
	@rm -f tmp/check.o tmp/check_comparison.o tmp/check_parse_stringify.o tmp/check_reference.o check.bin
.DEFAULT_GOAL := all
